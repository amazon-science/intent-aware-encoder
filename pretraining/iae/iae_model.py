...
class IAEModel(object):
    """
    Wrapper class for IAEModel 
    """
    ...
    def encode(self, sentences, max_length=50, agg_mode="cls"):
        ...
        if agg_mode=="cls":
            ...
            query_embed = last_hidden_state * sent_toks_cuda['attention_mask'].unsqueeze(-1)
            query_embed = query_embed.sum(1) / sent_toks_cuda['attention_mask'].sum(1).unsqueeze(-1)
